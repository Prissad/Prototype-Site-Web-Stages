...
<div class="container">
    <div class="row">
        <div class="col-lg-6"><a href="#"><button class="btn-lg btn-danger">Supprimer une offre</button> </a> </div>
        <div class="col-lg-6"><a href="#"><button class="btn-lg btn-danger">Supprimer un compte</button> </a> </div>
    </div>
</div>
